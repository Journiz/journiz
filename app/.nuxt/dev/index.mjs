...
const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"apiUrl":"https://dev.journiz.leoboyer.dev","pwaManifest":{"name":"Nuxt PWA","short_name":"","description":"","lang":"en","start_url":"/?standalone=true","display":"standalone","background_color":"#ffffff","theme_color":"#000000","icons":[]}}};
...
const serverAssets = [{"baseName":"server","dir":"/Users/ponk/gobelins/journiz/journiz/app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ponk/gobelins/journiz/journiz/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/ponk/gobelins/journiz/journiz/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ponk/gobelins/journiz/journiz/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/ponk/gobelins/journiz/journiz/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_8Y1AcI = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_8Y1AcI, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8Y1AcI, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/Users/ponk/gobelins/journiz/journiz/app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
