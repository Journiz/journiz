...
const props = defineProps({
    noPermissionMessage: {
        type: String,
        default: "Tu as refusé l'accès à ton micro, ton équipe ne pourra pas avoir de cri de guerre... C'est pas très fun."
    },
})
                ...
                <div class="relative w-full h-8 flex">
                    <button
                        ...
                        <transition name="playpause" mode="out-in">
                            <span
                                  v-if="isPlaying"
                                  class="block text-24px i-fluent:pause-32-filled text-green"></span>
                            <span
                                  v-else
                                  class="block text-24px i-fluent:triangle-right-32-filled"></span>
                        </transition>
                    </button>
