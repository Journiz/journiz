<template>
  <div class="i-button h-4 w-auto cursor-pointer">
    <div
      class="hover-window absolute top-2 left-12 text-center py-2 pr-4 pl-8 bg-white rounded-xl mw-78 drop-shadow-md font-light pointer-events-none"
    >
      <slot />
    </div>
    <svg
